...
import { SortColumn, SortDirection } from './prepared-order-sortable.directive';
...
export class PreparedOrderGridService {
  ...
  private _search(): Observable<SearchResult> {
    ...
    debugger;
    return this.client.getPreparedOrders(page, pageSize, sortColumn, sortDirection, searchTerm)
      .pipe(
