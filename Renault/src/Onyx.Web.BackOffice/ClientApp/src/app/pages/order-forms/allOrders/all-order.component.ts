...
import { AllOrderGridService } from "./all-order-grid.service";
import {
  NgbdAllOrderSortableHeader,
  SortEvent,
} from "./all-order-sortable.directive";
...
export class AllOrderComponent {
  ...
  @ViewChildren(NgbdAllOrderSortableHeader)
  orders!: QueryList<NgbdAllOrderSortableHeader>;
