...
import { SortColumn, SortDirection } from './employee-sortable.directive';
...
export class EmployeeGridService {
  ...
  private _search(): Observable<SearchResult> {
    ...
    debugger;
    return this.client.getEmployeesWithPagination(page, pageSize, sortColumn, sortDirection, searchTerm)
      .pipe(
        map((result: FilteredUser) => {
          ...
          searchResult.employees = employees as any;
