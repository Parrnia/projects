...
import { NgbdCostRefundedReturnOrderSortableHeader } from './cost-refunded-return-order-sortable.directive';
...
@NgModule({
  declarations: [
    NgbdCostRefundedReturnOrderSortableHeader,
    CostRefundedReturnOrderComponent,
...
export class CostRefundedReturnOrderModule { 
  constructor() {
