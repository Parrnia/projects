...
import { FilterVehicleCheckComponent } from './filters/filter-vehicle-brand-check/filter-vehicle-brand-check.component';
import { FilterProductCheckComponent } from './filters/filter-product-brand-check/filter-product-brand-check.component';
...
import { FilterMaterialComponent } from './filters/filter-material/filter-material.component';
...
@NgModule({
    declarations: [
        ...
        FilterProductCheckComponent,
        FilterVehicleCheckComponent,
