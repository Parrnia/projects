...
import { SortColumn, SortDirection } from './payment-unconfirmed-order-sortable.directive';
...
export class UnconfirmPaymentedOrderGridService {
  ...
  private _search(): Observable<SearchResult> {
    ...
    debugger;
    return this.client.getPaymentUnconfirmedOrders(page, pageSize, sortColumn, sortDirection, searchTerm)
      .pipe(
