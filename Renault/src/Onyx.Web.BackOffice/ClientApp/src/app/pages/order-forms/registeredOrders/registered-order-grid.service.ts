...
import { SortColumn, SortDirection } from './registered-order-sortable.directive';
...
export class RegisteredOrderGridService {
  ...
  private _search(): Observable<SearchResult> {
    ...
    debugger;
    return this.client.getRegisteredOrders(page, pageSize, sortColumn, sortDirection, searchTerm)
      .pipe(
