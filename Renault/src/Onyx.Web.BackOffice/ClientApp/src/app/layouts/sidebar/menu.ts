...
export const MENU: MenuItem[] = [
  ...
  // {
  //   id: 201,
  //   label: 'MENUITEMS.PRODUCTCATEGORY.TEXT',
  //   icon: 'ri-dashboard-2-line',
  //   subItems: [
  //     {
  //       id: 202,
  //       label: 'MENUITEMS.PRODUCTCATEGORY.LIST.PRODUCTGROUP',
  //       link: '/product-group',
  //       parentId: 201
  //     },
  //     {
  //       id: 203,
  //       label: 'MENUITEMS.PRODUCTCATEGORY.LIST.PRODUCTCATEGORY',
  //       link: '/product-category',
  //       parentId: 201
  //     },
  //     {
  //       id: 204,
  //       label: 'MENUITEMS.PRODUCTCATEGORY.LIST.PRODUCTSUBCATEGORY',
