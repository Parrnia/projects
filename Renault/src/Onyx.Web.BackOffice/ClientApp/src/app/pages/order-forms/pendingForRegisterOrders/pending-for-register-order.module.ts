...
import { NgbdpendingForRegisterOrderSortableHeader } from "./pending-for-register-order-sortable.directive";
...
@NgModule({
  declarations: [
    ...
    PendingForRegisterOrderComponent,
    OrderItemsComponent,
...
export class PendingForRegisterOrderModule {
  constructor() {
