...
public class CreateCorporationInfoCommandValidator : AbstractValidator<CreateCorporationInfoCommand>
{
    private readonly IApplicationDbContext _context;
    public CreateCorporationInfoCommandValidator(IApplicationDbContext context)
    {
        _context = context;
