...
import { SortColumn, SortDirection } from './some-confirmed-return-order-sortable.directive';
...
export class SomeConfirmedReturnOrderGridService {
  ...
  private _search(): Observable<SearchResult> {
    ...
    debugger;
    return this.client.getSomeConfirmedReturnOrders(page, pageSize, sortColumn, sortDirection, searchTerm)
      .pipe(
