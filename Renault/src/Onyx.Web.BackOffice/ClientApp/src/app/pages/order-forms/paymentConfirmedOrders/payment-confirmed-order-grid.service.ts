...
import { SortColumn, SortDirection } from './payment-confirmed-order-sortable.directive';
...
export class ConfirmPaymentOrderGridService {
  ...
  private _search(): Observable<SearchResult> {
    ...
    debugger;
    return this.client.getPaymentConfirmedOrders(page, pageSize, sortColumn, sortDirection, searchTerm)
      .pipe(
