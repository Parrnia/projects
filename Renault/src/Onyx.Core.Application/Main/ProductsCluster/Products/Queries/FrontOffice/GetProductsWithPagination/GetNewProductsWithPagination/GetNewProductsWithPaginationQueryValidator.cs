...
public class GetNewProductsWithPaginationQueryValidator : AbstractValidator<GetNewProductsWithPaginationQuery>
{
    public GetNewProductsWithPaginationQueryValidator()
    {
