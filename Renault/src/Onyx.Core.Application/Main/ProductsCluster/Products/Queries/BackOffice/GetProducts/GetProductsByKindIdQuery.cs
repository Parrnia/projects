...
public record GetProductsByKindIdQuery : IRequest<List<ProductDto>>
{
    public int KindId { get; init; }
    public CustomerTypeEnum CustomerTypeEnum { get; set; }
}

public class GetProductsByKindIdQueryHandler : IRequestHandler<GetProductsByKindIdQuery, List<ProductDto>>
{
    private readonly IApplicationDbContext _context;
    private readonly IMapper _mapper;

    public GetProductsByKindIdQueryHandler(IApplicationDbContext context, IMapper mapper)
    {
        _context = context;
        _mapper = mapper;
    }

    public async Task<List<ProductDto>> Handle(GetProductsByKindIdQuery request, CancellationToken cancellationToken)
    {
