...
public class GetSalesProductsWithPaginationQueryValidator : AbstractValidator<GetSalesProductsWithPaginationQuery>
{
    public GetSalesProductsWithPaginationQueryValidator()
    {
