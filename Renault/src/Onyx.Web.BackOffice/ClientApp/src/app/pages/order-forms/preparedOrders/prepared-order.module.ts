...
import { NgbdPreparedOrderSortableHeader } from './prepared-order-sortable.directive';
...
@NgModule({
  declarations: [
    NgbdPreparedOrderSortableHeader,
    PreparedOrderComponent,
    OrderItemsComponent,
...
export class PreparedOrderModule {
  constructor() {
