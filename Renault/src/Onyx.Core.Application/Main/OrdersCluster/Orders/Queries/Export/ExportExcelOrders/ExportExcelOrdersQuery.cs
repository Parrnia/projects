...
public record ExportExcelOrdersQuery() : IRequest<byte[]>
{
...
public class ExportExcelOrdersQueryHandler : IRequestHandler<ExportExcelOrdersQuery, byte[]>
{
    private readonly IApplicationDbContext _context;
    private readonly IExportServices _exportServices;


    public ExportExcelOrdersQueryHandler(IApplicationDbContext context, IExportServices exportServices)
    {
        _context = context;
        _exportServices = exportServices;
    }

    public async Task<byte[]> Handle(ExportExcelOrdersQuery request, CancellationToken cancellationToken)
    {
