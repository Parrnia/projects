...
import { SortColumn, SortDirection } from './canceled-order-sortable.directive';
...
export class CanceledOrderGridService {
  ...
  private _search(): Observable<SearchResult> {
    ...
    debugger;
    return this.client.getCanceledOrders(page, pageSize, sortColumn, sortDirection, searchTerm)
      .pipe(
