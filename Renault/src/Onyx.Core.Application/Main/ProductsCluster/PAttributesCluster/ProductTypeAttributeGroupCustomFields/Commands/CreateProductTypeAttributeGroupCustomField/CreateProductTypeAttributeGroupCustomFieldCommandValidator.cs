...
public class CreateProductTypeAttributeGroupCustomFieldCommandValidator : AbstractValidator<CreateProductTypeAttributeGroupCustomFieldCommand>
{
    public CreateProductTypeAttributeGroupCustomFieldCommandValidator(IApplicationDbContext context)
    {
