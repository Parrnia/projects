...
public class GetFeaturedProductsByProductCategoryIdWithPaginationQueryValidator : AbstractValidator<GetFeaturedProductsByProductCategoryIdWithPaginationQuery>
{
    public GetFeaturedProductsByProductCategoryIdWithPaginationQueryValidator()
    {
