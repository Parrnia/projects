...
import { NgbdUnconfirmedPaymentOrderSortableHeader } from './payment-unconfirmed-order-sortable.directive';
...
@NgModule({
  declarations: [
    NgbdUnconfirmedPaymentOrderSortableHeader,
    UnconfirmedPaymentOrderComponent,
    OrderItemsComponent,
...
export class UnconfirmedPaymentOrderModule {
  constructor() {
