...
export const MENU: MenuItem[] = [
  ...
  {
    id: 2,
    label: 'MENUITEMS.LAYOUT.TEXT',
    collapseid: 'sidebarLayouts',
    icon: 'ri-palette-line',
    subItems: [
      {
        id: 101,
        label: 'MENUITEMS.LAYOUT.LIST.BLOCKBANNER',
        link: '/blockBanners',
        parentId: 2
      },
      {
        id: 102,
        label: 'MENUITEMS.LAYOUT.LIST.CAROUSEL',
        link: '/carousels',
        parentId: 2
      },
      {
        id: 103,
        label: 'MENUITEMS.LAYOUT.LIST.FOOTERLINKCONTAINER',
        link: '/footerLinkContainers',
        parentId: 2
      },
      {
        id: 104,
        label: 'MENUITEMS.LAYOUT.LIST.SOCIALLINK',
        link: '/socialLinks',
        parentId: 2
      }
      // {
      //   id: 105,
      //   label: 'MENUITEMS.LAYOUT.LIST.THEME',
      //   link: '/themes',
      //   parentId: 2
      // }
    ]
  ...
  {
    id: 301,
    label: 'MENUITEMS.BRANDSCLUSTER.TEXT',
    collapseid: 'sidebarBrands',
    icon: 'ri-award-line',
    subItems: [
      {
        id: 302,
        label: 'MENUITEMS.BRANDSCLUSTER.LIST.PRODUCTBRAND',
        link: '/productBrands',
        parentId: 301
      },
      {
        id: 303,
        label: 'MENUITEMS.BRANDSCLUSTER.LIST.VEHICLEBRAND',
        link: '/vehicleBrands',
        parentId: 301
      },
      {
        id: 304,
        label: 'MENUITEMS.BRANDSCLUSTER.LIST.FAMILY',
        link: '/families',
        parentId: 301
      },
      {
        id: 305,
        label: 'MENUITEMS.BRANDSCLUSTER.LIST.MODEL',
        link: '/models',
        parentId: 301
      },
      {
        id: 306,
        label: 'MENUITEMS.BRANDSCLUSTER.LIST.KINDS',
        link: '/kinds',
        parentId: 301
      },
      {
        id: 307,
        label: 'MENUITEMS.BRANDSCLUSTER.LIST.VEHICLES',
        link: '/vehicles',
        parentId: 301
      },
    ]
  ...
  {
    id: 401,
    label: 'MENUITEMS.PRODUCTCATEGORIESCLUSTER.TEXT',
    collapseid: 'sidebarCategories',
    icon: 'ri-organization-chart',
    subItems: [
      {
        id: 402,
        label: 'MENUITEMS.PRODUCTCATEGORIESCLUSTER.LIST.PRODUCTCATEGORY',
  ...
  {
    id: 501,
    label: 'MENUITEMS.INFOCLUSTER.TEXT',
    collapseid: 'sidebarInfo',
    icon: 'ri-information-line',
    subItems: [
      {
        id: 502,
        label: 'MENUITEMS.INFOCLUSTER.LIST.ABOUTUS',
        link: '/aboutUs',
        parentId: 501
      },
      {
        id: 503,
        label: 'MENUITEMS.INFOCLUSTER.LIST.CORPORATIONINFO',
        link: '/corporationInfo',
        parentId: 501
      },
      {
        id: 504,
        label: 'MENUITEMS.INFOCLUSTER.LIST.COUNTRY',
        link: '/country',
        parentId: 501
      },
      {
        id: 505,
        label: 'MENUITEMS.INFOCLUSTER.LIST.QUESTION',
        link: '/question',
        parentId: 501
      },
      {
        id: 506,
        label: 'MENUITEMS.INFOCLUSTER.LIST.TEAMMEMBER',
        link: '/teamMember',
        parentId: 501
      },
      {
        id: 507,
        label: 'MENUITEMS.INFOCLUSTER.LIST.TESTIMONIAL',
        link: '/testimonial',
        parentId: 501
      }
    ]
  ...
  {
    id: 601,
    label: 'MENUITEMS.PRODUCTPROPERTIESCLUSTER.TEXT',
    collapseid: 'sidebarProductProperties',
    icon: 'las la-shapes',
    subItems: [
     
      {
        id: 602,
        label: 'MENUITEMS.PRODUCTPROPERTIESCLUSTER.LIST.BADGE',
        link: '/badge',
        parentId: 601
      },
      {
        id: 603,
        label: 'MENUITEMS.PRODUCTPROPERTIESCLUSTER.LIST.COUNTINGUNIT',
        link: '/countingUnit',
        parentId: 601
      },
      {
        id: 604,
        label: 'MENUITEMS.PRODUCTPROPERTIESCLUSTER.LIST.COUNTINGUNITTYPE',
        link: '/countingUnitType',
        parentId: 601
      },
      {
        id: 605,
        label: 'MENUITEMS.PRODUCTPROPERTIESCLUSTER.LIST.PRODUCTSTATUS',
        link: '/productStatus',
        parentId: 601
      },
      {
        id: 606,
        label: 'MENUITEMS.PRODUCTPROPERTIESCLUSTER.LIST.PRODUCTTYPE',
        link: '/productType',
        parentId: 601
      },
      {
        id: 607,
        label: 'MENUITEMS.PRODUCTPROPERTIESCLUSTER.LIST.PROVIDER',
        link: '/provider',
        parentId: 601
      },
      {
        id: 608,
        label: 'MENUITEMS.PRODUCTPROPERTIESCLUSTER.LIST.REVIEW',
        link: '/review',
        parentId: 601
      },
      {
        id: 609,
        label: 'MENUITEMS.PRODUCTPROPERTIESCLUSTER.LIST.TAG',
        link: '/tag',
        parentId: 601
      },
    ]
  ...
  ,
  {
    ...
    subItems: [
      ...
      {
        id: 703,
        label: 'MENUITEMS.PRODUCTS.LIST.PRODUCTATTRIBUTETYPES',
        link: '/productAttributeTypes',
        parentId: 701
      },
      {
        id: 704,
        label: 'MENUITEMS.PRODUCTS.LIST.PRODUCTTYPEATTRIBUTEGROUPS',
        link: '/productAttributeGroups',
        parentId: 701
      },
      {
        id: 705,
        label: 'MENUITEMS.PRODUCTS.LIST.PRODUCTTYPEATTRIBUTEGROUPATTRIBUTES',
        link: '/productAttributeGroupAttributes',
        parentId: 701
      },
      {
        id: 706,
        label: 'MENUITEMS.PRODUCTS.LIST.PRODUCTATTRIBUTEOPTIONCOLOR',
        link: '/productOptionColor',
        parentId: 701
      },
      {
        id: 707,
        label: 'MENUITEMS.PRODUCTS.LIST.PRODUCTATTRIBUTEOPTIONMATERIAL',
        link: '/productOptionMaterial',
        parentId: 701
      }
    ]
  },
  {
    id: 850,
    label: 'MENUITEMS.RETURNORDERS.TEXT',
    icon: 'ri-shopping-cart-2-line',
    subItems: [
      {
        id: 851,
        label: 'MENUITEMS.RETURNORDERS.LIST.ALLRETURNORDERS',
        link: '/allReturnOrders',
        parentId: 850
      },
      {
        id: 852,
        label: 'MENUITEMS.RETURNORDERS.LIST.ACCEPTEDRETURNORDERS',
        link: '/acceptedReturnOrders',
        parentId: 850
      }, 
      {
        id: 853,
        label: 'MENUITEMS.RETURNORDERS.LIST.ALLCONFIRMEDRETURNORDERS',
        link: '/allConfirmedReturnOrders',
        parentId: 850
      }, 
      {
        id: 854,
        label: 'MENUITEMS.RETURNORDERS.LIST.CANCELEDRETURNORDERS',
        link: '/canceledReturnOrders',
        parentId: 850
      }, 
      {
        id: 855,
        label: 'MENUITEMS.RETURNORDERS.LIST.COMPLETEDRETURNORDERS',
        link: '/completedReturnOrders',
        parentId: 850
      }, 
      {
        id: 856,
        label: 'MENUITEMS.RETURNORDERS.LIST.COSTREFUNDEDRETURNORDERS',
        link: '/costRefundedReturnOrders',
        parentId: 850
      }, 
      {
        id: 857,
        label: 'MENUITEMS.RETURNORDERS.LIST.RECEIVEDRETURNORDERS',
        link: '/receivedReturnOrders',
        parentId: 850
      }, 
      {
        id: 858,
        label: 'MENUITEMS.RETURNORDERS.LIST.REGISTEREDRETURNORDERS',
        link: '/registeredReturnOrders',
        parentId: 850
      }, 
      {
        id: 859,
        label: 'MENUITEMS.RETURNORDERS.LIST.REJECTEDRETURNORDERS',
        link: '/rejectedReturnOrders',
        parentId: 850
      }, 
      {
        id: 860,
        label: 'MENUITEMS.RETURNORDERS.LIST.SENTRETURNORDERS',
        link: '/sentReturnOrders',
        parentId: 850
      }, 
      {
        id: 861,
        label: 'MENUITEMS.RETURNORDERS.LIST.SOMECONFIRMEDRETURNORDERS',
        link: '/someConfirmedReturnOrders',
        parentId: 850
      }
    ]
  },
  {
    ...
    collapseid: 'sidebarOrders',
    icon: 'ri-shopping-cart-2-line',
    subItems: [
     
      {
        id: 802,
        label: 'MENUITEMS.ORDERS.LIST.ALLORDERS',
        link: '/allOrders',
        parentId: 801
      },
      {
        id: 803,
        label: 'MENUITEMS.ORDERS.LIST.CANCELEDORDERS',
        link: '/canceledOrders',
        parentId: 801
      },
      {
        id: 804,
        label: 'MENUITEMS.ORDERS.LIST.CONFIRMEDORDERS',
        link: '/confirmedOrders',
        parentId: 801
      },
      {
        id: 805,
        label: 'MENUITEMS.ORDERS.LIST.COSTREFUNDEDORDERS',
        link: '/costRefundedOrders',
        parentId: 801
      },
      {
        id: 806,
        label: 'MENUITEMS.ORDERS.LIST.PREPAREDORDERS',
        link: '/preparedOrders',
        parentId: 801
      },
      {
        id: 807,
        label: 'MENUITEMS.ORDERS.LIST.REGISTEREDORDERS',
        link: '/registeredOrders',
        parentId: 801
      },
      {
        id: 808,
        label: 'MENUITEMS.ORDERS.LIST.SHIPPEDORDERS',
        link: '/shippedOrders',
        parentId: 801
      },
      {
        id: 809,
        label: 'MENUITEMS.ORDERS.LIST.UNCONFIRMEDORDERS',
        link: '/unconfirmedOrders',
        parentId: 801
      },
      {
        id: 810,
        label: 'MENUITEMS.ORDERS.LIST.PAYMENTUNCONFIRMEDORDERS',
        link: '/paymentUnconfirmedOrders',
        parentId: 801
      },
      {
        id: 811,
        label: 'MENUITEMS.ORDERS.LIST.PAYMENTCONFIRMEDORDERS',
        link: '/paymentConfirmedOrders',
        parentId: 801
      },
      {
        id: 812,
        label: 'MENUITEMS.ORDERS.LIST.COMPLETEDORDERS',
        link: '/completeOrders',
        parentId: 801
      },
       {
        id: 813,
        label: 'MENUITEMS.ORDERS.LIST.PENDINGFORREGISTER',
        link: '/pendingForRegister',
        parentId: 801
      },
  ...
  {
    id: 901,
    label: 'MENUITEMS.MANAGEUSER.TEXT',
    collapseid: 'sidebarManageUser',
    icon: 'ri-team-line',
    subItems: [
     
      {
        id: 902,
        label: 'MENUITEMS.MANAGEUSER.LIST.CUSTOMERS',
        link: '/customers',
        parentId: 901
      },
      {
        id: 903,
        label: 'MENUITEMS.MANAGEUSER.LIST.CUSTOMERSCREDIT',
        link: '/customersCredit',
        parentId: 901
      },
      {
        id: 904,
        label: 'MENUITEMS.MANAGEUSER.LIST.EMPLOYEE',
        link: '/employees',
        parentId: 901
      },
      {
        id: 905,
        label: 'MENUITEMS.MANAGEUSER.LIST.GROUP',
        link: '/groups',
        parentId: 901
      },
      {
        id: 906,
        label: 'MENUITEMS.MANAGEUSER.LIST.CUSTOMERTYPE',
        link: '/customerTypes',
        parentId: 901
      }
    ]
  ...
  {
    id: 1001,
    label: 'MENUITEMS.CUSTOMERTICKETSCLUSTER.TEXT',
    collapseid: 'sidebarTicket',
    icon: 'ri-customer-service-line',
    subItems: [
      {
        id: 1002,
        label: 'MENUITEMS.CUSTOMERTICKETSCLUSTER.LIST.TICKET',
        link: '/customerTickets',
        parentId: 1001
      }
    ]
  },
  {
    id: 1101,
    label: 'MENUITEMS.REQUESTSCLUSTER.TEXT',
    collapseid: 'sidebarRequest',
    icon: 'ri-git-pull-request-line',
    subItems: [
      {
        id: 1102,
        label: 'MENUITEMS.REQUESTSCLUSTER.LIST.REQUESTLOGS',
        link: '/requestLogs',
        parentId: 1101
      }
    ]
