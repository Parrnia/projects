...
import { SortColumn, SortDirection } from './completed-return-order-sortable.directive';
...
export class CompletedReturnOrderGridService {
  ...
  private _search(): Observable<SearchResult> {
    ...
    debugger;
    return this.client.getCompletedReturnOrders(page, pageSize, sortColumn, sortDirection, searchTerm)
      .pipe(
