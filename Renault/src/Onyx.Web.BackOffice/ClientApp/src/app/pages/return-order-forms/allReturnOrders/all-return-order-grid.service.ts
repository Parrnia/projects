...
import { SortColumn, SortDirection } from './all-return-order-sortable.directive';
...
export class AllReturnOrderGridService {
  ...
  private _search(): Observable<SearchResult> {
    ...
    debugger;
    return this.client.getReturnOrdersWithPagination(page, pageSize, sortColumn, sortDirection, searchTerm)
      .pipe(
