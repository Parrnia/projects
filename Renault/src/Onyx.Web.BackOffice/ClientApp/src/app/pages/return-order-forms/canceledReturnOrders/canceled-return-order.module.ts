...
import { NgbdCanceledReturnOrderSortableHeader } from './canceled-return-order-sortable.directive';
...
@NgModule({
  declarations: [
    NgbdCanceledReturnOrderSortableHeader,
    CanceledReturnOrderComponent,
...
export class CanceledReturnOrderModule { 
  constructor() {
