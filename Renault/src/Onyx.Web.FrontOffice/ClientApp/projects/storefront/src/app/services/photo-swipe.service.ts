...
export class PhotoSwipeService implements OnDestroy {
    ...
    constructor(private zone: NgZone, private resources: ResourcesService) {}
    ...
    private createGallery(
        observer: Subscriber<PhotoSwipeModelRef>,
        items: PhotoSwipeItem[],
        options: PhotoSwipeOptions
    ): void {
        ...
        const modelRef: PhotoSwipeModelRef = {
            ...
            listen: (eventName, callbackFn) =>
                gallery.listen(eventName, (...args: any[]) => {
