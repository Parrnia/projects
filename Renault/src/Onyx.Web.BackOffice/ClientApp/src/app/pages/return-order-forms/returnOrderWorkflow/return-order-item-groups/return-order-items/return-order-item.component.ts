...
import { CreateReturnOrderItemCommand, DeleteRangeReturnOrderItemCommand, ProductOptionColorsClient, ReturnOrderCustomerReasonType, ReturnOrderDto, ReturnOrderItemsClient, ReturnOrderOrganizationReasonType, UpdateReturnOrderItemCommand } from "src/app/web-api-client";
...
export class ReturnOrderItemsComponent {
  ...
  @Input() returnOrder?: ReturnOrderDto;
