...
import { NgbdCostRefundedOrderSortableHeader } from './cost-refunded-order-sortable.directive';
...
@NgModule({
  declarations: [
    NgbdCostRefundedOrderSortableHeader,
    CostRefundedOrderComponent,
    OrderItemsComponent,
...
export class CostRefundedOrderModule {
  constructor() {
