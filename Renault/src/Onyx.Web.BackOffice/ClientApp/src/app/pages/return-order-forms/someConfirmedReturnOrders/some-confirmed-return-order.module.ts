...
import { NgbdSomeConfirmedReturnOrderSortableHeader } from './some-confirmed-return-order-sortable.directive';
...
@NgModule({
  declarations: [
    NgbdSomeConfirmedReturnOrderSortableHeader,
    SomeConfirmedReturnOrderComponent,
...
export class SomeConfirmedReturnOrderModule { 
  constructor() {
