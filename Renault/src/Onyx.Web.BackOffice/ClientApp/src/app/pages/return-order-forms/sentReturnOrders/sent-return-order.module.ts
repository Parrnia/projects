...
import { NgbdSentReturnOrderSortableHeader } from './sent-return-order-sortable.directive';
...
@NgModule({
  declarations: [
    NgbdSentReturnOrderSortableHeader,
    SentReturnOrderComponent,
...
export class SentReturnOrderModule { 
  constructor() {
