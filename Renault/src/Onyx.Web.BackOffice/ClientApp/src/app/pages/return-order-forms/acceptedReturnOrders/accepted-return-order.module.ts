...
import { NgbdAcceptedReturnOrderSortableHeader } from './accepted-return-order-sortable.directive';
...
@NgModule({
  declarations: [
    NgbdAcceptedReturnOrderSortableHeader,
    AcceptedReturnOrderComponent,
...
export class AcceptedReturnOrderModule { 
  constructor() {
