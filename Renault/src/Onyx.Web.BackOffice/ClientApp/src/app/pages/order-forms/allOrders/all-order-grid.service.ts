...
import { SortColumn, SortDirection } from './all-order-sortable.directive';
...
export class AllOrderGridService {
  ...
  private _search(): Observable<SearchResult> {
    ...
    debugger;
    return this.client.getOrdersWithPagination(page, pageSize, sortColumn, sortDirection, searchTerm)
      .pipe(
