...
public class GetTopRatedProductsWithPaginationQueryValidator : AbstractValidator<GetTopRatedProductsWithPaginationQuery>
{
    public GetTopRatedProductsWithPaginationQueryValidator()
    {
