...
import { ReturnOrdersClient, CountryDto, FileParameter, ModelDto, ModelsClient, FileUploadMetadataDto, UpdateReturnOrderTotalDocumentCommand, CreateReturnOrderTotalDocumentCommand, DeleteRangeReturnOrderTotalDocumentCommand, ReturnOrderTotalDocumentsClient } from 'src/app/web-api-client';
...
export class ReturnOrderTotalDocumentComponent {
  ...
  @Input('returnOrderId') returnOrderId?: number;
