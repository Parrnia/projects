...
import { SortColumn, SortDirection } from './sent-return-order-sortable.directive';
...
export class SentReturnOrderGridService {
  ...
  private _search(): Observable<SearchResult> {
    ...
    debugger;
    return this.client.getSentReturnOrders(page, pageSize, sortColumn, sortDirection, searchTerm)
      .pipe(
