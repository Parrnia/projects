...
import { SortColumn, SortDirection } from './unconfirmed-order-sortable.directive';
...
export class UnconfirmedOrderGridService {
  ...
  private _search(): Observable<SearchResult> {
    ...
    debugger;
    return this.client.getUnconfirmedOrders(page, pageSize, sortColumn, sortDirection, searchTerm)
      .pipe(
