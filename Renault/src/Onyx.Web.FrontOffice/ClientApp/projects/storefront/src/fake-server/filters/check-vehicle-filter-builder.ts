import { BaseFilterItem, CheckProductFilter, CheckVehicleFilter } from '../../app/interfaces/filter';
import { Product } from '../../app/interfaces/product';
import { products as dbProducts } from '../database/products';
import { AbstractFilterBuilder } from './abstract-filter-builder';

export class CheckVehicleFilterBuilder extends AbstractFilterBuilder {
