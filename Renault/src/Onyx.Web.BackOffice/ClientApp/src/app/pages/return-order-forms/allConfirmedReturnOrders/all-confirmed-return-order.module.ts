...
import { NgbdAllConfirmedReturnOrderSortableHeader } from './all-confirmed-return-order-sortable.directive';
...
@NgModule({
  declarations: [
    NgbdAllConfirmedReturnOrderSortableHeader,
    AllConfirmedReturnOrderComponent,
...
export class AllConfirmedReturnOrderModule { 
  constructor() {
