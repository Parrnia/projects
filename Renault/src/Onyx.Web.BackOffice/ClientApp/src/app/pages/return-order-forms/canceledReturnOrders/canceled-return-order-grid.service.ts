...
import { SortColumn, SortDirection } from './canceled-return-order-sortable.directive';
...
export class CanceledReturnOrderGridService {
  ...
  private _search(): Observable<SearchResult> {
    ...
    debugger;
    return this.client.getCanceledReturnOrders(page, pageSize, sortColumn, sortDirection, searchTerm)
      .pipe(
