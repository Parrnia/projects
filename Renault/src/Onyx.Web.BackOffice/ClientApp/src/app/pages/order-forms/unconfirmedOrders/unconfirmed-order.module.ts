...
import { NgbdUnconfirmedOrderSortableHeader } from './unconfirmed-order-sortable.directive';
...
@NgModule({
  declarations: [
    NgbdUnconfirmedOrderSortableHeader,
    UnconfirmedOrderComponent,
    OrderItemsComponent,
...
export class UnconfirmedOrderModule {
  constructor() {
