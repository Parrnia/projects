...
import { SortColumn, SortDirection } from './completed-order-sortable.directive';
...
export class CompletedOrderGridService {
  ...
  private _search(): Observable<SearchResult> {
    ...
    debugger;
    return this.client.getCompletedOrders(page, pageSize, sortColumn, sortDirection, searchTerm)
      .pipe(
