...
namespace Onyx.Application.Main.RequestsCluster.RequestLogs.Commands.ResendRequests;
public record ResendCancelOrderRequestsCommand : IRequest<bool>
{
    public IEnumerable<int> Ids { get; init; } = new List<int>();
}

public class ResendCancelOrderRequestsCommandHandler : IRequestHandler<ResendCancelOrderRequestsCommand, bool>
{
    private readonly IApplicationDbContext _context;
    private readonly ISevenSoftService _sevenSoftService;
    private readonly ApplicationSettings _applicationSettings;

    public ResendCancelOrderRequestsCommandHandler(
    ...
    public async Task<bool> Handle(ResendCancelOrderRequestsCommand request, CancellationToken cancellationToken)
    {
