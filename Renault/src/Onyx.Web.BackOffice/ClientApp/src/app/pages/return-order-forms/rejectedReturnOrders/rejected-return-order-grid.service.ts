...
import { SortColumn, SortDirection } from './rejected-return-order-sortable.directive';
...
export class RejectedReturnOrderGridService {
  ...
  private _search(): Observable<SearchResult> {
    ...
    debugger;
    return this.client.getRejectedReturnOrders(page, pageSize, sortColumn, sortDirection, searchTerm)
      .pipe(
