...
public class GetProductsByKindIdWithPaginationQueryValidator : AbstractValidator<GetProductsByKindIdWithPaginationQuery>
{
    public GetProductsByKindIdWithPaginationQueryValidator()
    {
        RuleFor(x => x.KindId)
