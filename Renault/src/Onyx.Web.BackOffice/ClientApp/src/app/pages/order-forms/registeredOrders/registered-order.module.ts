...
import { NgbdRegisteredOrderSortableHeader } from './registered-order-sortable.directive';
...
@NgModule({
  declarations: [
    NgbdRegisteredOrderSortableHeader,
    RegisteredOrderComponent,
    OrderItemsComponent,
...
export class RegisteredOrderModule {
  constructor() {
