...
import { SortColumn, SortDirection } from './cost-refunded-order-sortable.directive';
...
export class CostRefundedOrderGridService {
  ...
  private _search(): Observable<SearchResult> {
    ...
    debugger;
    return this.client.getCostRefundedOrders(page, pageSize, sortColumn, sortDirection, searchTerm)
      .pipe(
