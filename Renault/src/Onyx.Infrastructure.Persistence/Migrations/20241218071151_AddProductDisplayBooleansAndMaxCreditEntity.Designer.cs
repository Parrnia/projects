...
namespace Onyx.Infrastructure.Migrations
{
    ...
    [Migration("20241218071151_AddProductDisplayBooleansAndMaxCreditEntity")]
    partial class AddProductDisplayBooleansAndMaxCreditEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Onyx.Domain.Entities.UserProfilesCluster.Credit", b =>
                {
                    ...
                    b.ToTable("Credits", t =>
                        {
                            t.HasCheckConstraint("CK_Credit_Value_NonNegative", "Value >= 0");
                        });
                });
            ...
            modelBuilder.Entity("Onyx.Domain.Entities.UserProfilesCluster.MaxCredit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
