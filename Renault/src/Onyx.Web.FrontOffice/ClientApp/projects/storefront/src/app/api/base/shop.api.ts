...
import { Product, ProductAttributeOption } from '../../interfaces/product';
import { Brand } from '../../interfaces/brand';
import { ProductsList, ReviewsList } from '../../interfaces/list';
import { Review } from '../../interfaces/review';
import { Order } from '../../interfaces/order';
import { AddressData } from '../../interfaces/address';
import { OrderPaymentType, PaymentType } from '../../web-api-client';
...
export abstract class ShopApi {
    ...
    abstract getFeaturedProducts(categorySlug: string|null, limit: number): Observable<Product[]>;

    abstract getPopularProducts(categorySlug: string|null, limit: number): Observable<Product[]>;

    abstract getTopRatedProducts(categorySlug: string|null, limit: number): Observable<Product[]>;
