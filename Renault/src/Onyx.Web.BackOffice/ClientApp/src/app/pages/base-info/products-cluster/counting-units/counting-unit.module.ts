...
import { NgbdCountingUnitSortableHeader } from './counting-unit-sortable.directive';
...
@NgModule({
  declarations: [
    NgbdCountingUnitSortableHeader,
    CountingUnitComponent
  ],
  imports: [
    CommonModule,
    FormsModule,
...
export class CountingUnitModule { 
  constructor() {
