...
import { CostRefundedReturnOrderGridService } from './cost-refunded-return-order-grid.service';
import { NgbdCostRefundedReturnOrderSortableHeader, SortEvent } from './cost-refunded-return-order-sortable.directive';
...
@Component({
  selector: "app-cost-refunded-return-order",
  templateUrl: "./cost-refunded-return-order.component.html",
  styleUrls: ["./cost-refunded-return-order.component.scss"],
  providers: [CostRefundedReturnOrderGridService, DecimalPipe, NgbAlertConfig],
})
export class CostRefundedReturnOrderComponent {
  ...
  @ViewChildren(NgbdCostRefundedReturnOrderSortableHeader)
  returnOrders!: QueryList<NgbdCostRefundedReturnOrderSortableHeader>;
  ...
  constructor(
    ...
    public service: CostRefundedReturnOrderGridService,
  ...
  ngOnInit(): void {
    this.breadCrumbItems = [
      { label: 'سفارش بازگشت' },
      { label: 'لیست سفارشات بازگشت وجه بازپرداخت شده ', active: true }
    ];
  }
