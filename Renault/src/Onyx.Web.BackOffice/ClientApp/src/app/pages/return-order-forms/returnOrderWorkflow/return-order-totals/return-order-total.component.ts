...
import { CreateReturnOrderTotalCommand, DeleteRangeReturnOrderTotalCommand, ProductOptionColorsClient, ReturnOrderDto, ReturnOrderTotalApplyType, ReturnOrderTotalsClient, ReturnOrderTotalType, UpdateReturnOrderTotalCommand } from "src/app/web-api-client";
...
export class ReturnOrderTotalsComponent {
  ...
  @Input() returnOrder?: WorkflowReturnOrderModel;
  ...
  ngOnInit(): void {
    this.service.getReturnOrderTotalsByReturnOrderId(this.returnOrder?.id ?? 0);
  }
