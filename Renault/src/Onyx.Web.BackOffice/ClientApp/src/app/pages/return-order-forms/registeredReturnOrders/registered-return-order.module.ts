...
import { NgbdRegisteredReturnOrderSortableHeader } from './registered-return-order-sortable.directive';
...
@NgModule({
  declarations: [
    NgbdRegisteredReturnOrderSortableHeader,
    RegisteredReturnOrderComponent,
...
export class RegisteredReturnOrderModule { 
  constructor() {
