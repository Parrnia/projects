...
import { SortColumn, SortDirection } from './accepted-return-order-sortable.directive';
...
export class AcceptedReturnOrderGridService {
  ...
  get returnOrders$() {
    return this._returnOrders$.asObservable();
  }
  get total$() {
