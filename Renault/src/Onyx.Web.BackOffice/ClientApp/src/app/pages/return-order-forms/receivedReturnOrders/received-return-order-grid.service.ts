...
import { SortColumn, SortDirection } from './received-return-order-sortable.directive';
...
export class ReceivedReturnOrderGridService {
  ...
  private _search(): Observable<SearchResult> {
    ...
    debugger;
    return this.client.getReceivedReturnOrders(page, pageSize, sortColumn, sortDirection, searchTerm)
      .pipe(
