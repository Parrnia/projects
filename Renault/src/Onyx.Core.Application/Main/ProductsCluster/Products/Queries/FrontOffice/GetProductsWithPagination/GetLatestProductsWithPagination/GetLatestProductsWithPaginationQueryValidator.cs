...
public class GetLatestProductsWithPaginationQueryValidator : AbstractValidator<GetLatestProductsWithPaginationQuery>
{
    public GetLatestProductsWithPaginationQueryValidator()
    {
