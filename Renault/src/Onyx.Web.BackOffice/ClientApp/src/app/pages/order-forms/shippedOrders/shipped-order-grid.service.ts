...
import { SortColumn, SortDirection } from './shipped-order-sortable.directive';
...
export class ShippedOrderGridService {
  ...
  private _search(): Observable<SearchResult> {
    ...
    debugger;
    return this.client.getShippedOrders(page, pageSize, sortColumn, sortDirection, searchTerm)
      .pipe(
