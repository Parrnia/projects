...
import { NgbdReceivedReturnOrderSortableHeader } from './received-return-order-sortable.directive';
...
@NgModule({
  declarations: [
    NgbdReceivedReturnOrderSortableHeader,
    ReceivedReturnOrderComponent,
...
export class ReceivedReturnOrderModule { 
  constructor() {
