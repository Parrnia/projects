...
public class GetPopularProductsWithPaginationQueryValidator : AbstractValidator<GetPopularProductsWithPaginationQuery>
{
    public GetPopularProductsWithPaginationQueryValidator()
    {
