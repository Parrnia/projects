...
import { SortColumn, SortDirection } from './all-confirmed-return-order-sortable.directive';
...
export class AllConfirmedReturnOrderGridService {
  ...
  private _search(): Observable<SearchResult> {
    ...
    debugger;
    return this.client.getAllConfirmedReturnOrders(page, pageSize, sortColumn, sortDirection, searchTerm)
      .pipe(
