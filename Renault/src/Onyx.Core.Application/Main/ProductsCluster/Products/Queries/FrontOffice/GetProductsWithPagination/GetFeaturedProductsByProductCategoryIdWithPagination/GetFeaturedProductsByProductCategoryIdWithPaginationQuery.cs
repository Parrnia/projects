...
public record GetFeaturedProductsByProductCategoryIdWithPaginationQuery : IRequest<PaginatedList<FeaturedProductByProductCategoryIdWithPaginationDto>>
{
...
public class GetFeaturedProductsWithProductParentCategoryIdWithPaginationQueryHandler : IRequestHandler<GetFeaturedProductsByProductCategoryIdWithPaginationQuery, PaginatedList<FeaturedProductByProductCategoryIdWithPaginationDto>>
{
    ...
    public GetFeaturedProductsWithProductParentCategoryIdWithPaginationQueryHandler(IApplicationDbContext context, IMapper mapper, ISharedProductQueryHelperMethods productQueryHelperMethods)
    {
        _context = context;
        _mapper = mapper;
    ...
    public async Task<PaginatedList<FeaturedProductByProductCategoryIdWithPaginationDto>> Handle(GetFeaturedProductsByProductCategoryIdWithPaginationQuery request, CancellationToken cancellationToken)
    {
        ...
        var helperResult = await products.ProjectTo<FeaturedProductByProductCategoryIdWithPaginationModelHelperDto>(_mapper.ConfigurationProvider)
        ...
        var finalResult = new PaginatedList<FeaturedProductByProductCategoryIdWithPaginationDto>(result, helperResult.TotalCount, request.PageNumber, request.PageSize);
        return finalResult;
    }
