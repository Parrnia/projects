...
public record GetAllProductBrandsQuery : IRequest<List<ProductBrandDto>>;

public class GetAllProductBrandsQueryHandler : IRequestHandler<GetAllProductBrandsQuery, List<ProductBrandDto>>
{
