...
import { SortColumn, SortDirection } from './cost-refunded-return-order-sortable.directive';
...
export class CostRefundedReturnOrderGridService {
  ...
  private _search(): Observable<SearchResult> {
    ...
    debugger;
    return this.client.getCostRefundedReturnOrders(page, pageSize, sortColumn, sortDirection, searchTerm)
      .pipe(
