...
public class CreateVehicleBrandCommandValidator : AbstractValidator<CreateVehicleBrandCommand>
{
    private readonly IApplicationDbContext _context;
    public CreateVehicleBrandCommandValidator(IApplicationDbContext context)
    {
        _context = context;
