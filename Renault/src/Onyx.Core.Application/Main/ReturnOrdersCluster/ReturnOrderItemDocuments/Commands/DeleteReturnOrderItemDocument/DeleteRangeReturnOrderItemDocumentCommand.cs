...
public record DeleteRangeReturnOrderItemDocumentCommand : IRequest<Unit>
{
...
public class DeleteRangeReturnOrderItemDocumentCommandHandler : IRequestHandler<DeleteRangeReturnOrderItemDocumentCommand, Unit>
{
    private readonly IApplicationDbContext _context;
    private readonly IFileStore _fileStore;

    public DeleteRangeReturnOrderItemDocumentCommandHandler(IApplicationDbContext context, IFileStore fileStore)
    {
        _context = context;
        _fileStore = fileStore;
    }

    public async Task<Unit> Handle(DeleteRangeReturnOrderItemDocumentCommand request, CancellationToken cancellationToken)
    {
        ...
        foreach (var id in request.Ids)
        {
            ...
            {
                throw new NotFoundException(nameof(ReturnOrderItemDocument), id);
            }
