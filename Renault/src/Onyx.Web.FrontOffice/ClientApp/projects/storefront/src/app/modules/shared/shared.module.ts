...
import { PageAddressesCheckoutComponent } from '../account/pages/page-addresses-checkout/page-addresses-checkout.component';
import { AddressFormNewComponent } from './components/address-form-new/address-form-new.component';
import { FileUploadComponent } from './components/file-upload/file-upload.component';
import { AmountToWordsPipe } from './pipes/amountToWords.pipe';
...
@NgModule({
    declarations: [
        ...
        PageAddressesCheckoutComponent,
        FileUploadComponent,
        // directives
        AddToCartDirective,
