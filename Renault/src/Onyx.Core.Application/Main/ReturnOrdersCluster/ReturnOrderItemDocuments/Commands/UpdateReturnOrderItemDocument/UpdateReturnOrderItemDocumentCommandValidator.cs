...
public class UpdateReturnOrderItemDocumentCommandValidator : AbstractValidator<UpdateReturnOrderItemDocumentCommand>
{
    public UpdateReturnOrderItemDocumentCommandValidator()
    {
        RuleFor(v => v.Id)
