...
public record DeleteRangeReturnOrderTotalDocumentCommand : IRequest<Unit>
{
...
public class DeleteRangeReturnOrderTotalDocumentCommandHandler : IRequestHandler<DeleteRangeReturnOrderTotalDocumentCommand, Unit>
{
    private readonly IApplicationDbContext _context;
    private readonly IFileStore _fileStore;

    public DeleteRangeReturnOrderTotalDocumentCommandHandler(IApplicationDbContext context, IFileStore fileStore)
    {
        _context = context;
        _fileStore = fileStore;
    }

    public async Task<Unit> Handle(DeleteRangeReturnOrderTotalDocumentCommand request, CancellationToken cancellationToken)
    {
        ...
        foreach (var id in request.Ids)
        {
            ...
            {
                throw new NotFoundException(nameof(ReturnOrderTotalDocument), id);
            }
