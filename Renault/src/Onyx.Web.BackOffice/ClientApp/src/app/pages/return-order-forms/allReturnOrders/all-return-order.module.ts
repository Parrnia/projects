...
import { NgbdAllReturnOrderSortableHeader } from './all-return-order-sortable.directive';
...
@NgModule({
  declarations: [
    NgbdAllReturnOrderSortableHeader,
    AllReturnOrderComponent,
...
export class AllReturnOrderModule { 
  constructor() {
